      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Cryptocurrency trading platform based on trading intent - you define what you want, system finds optimal execution.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Define your trading intent (buy X amount of token)</li>
            <li>Submit intent to decentralized matching network</li>
            <li>Orchestrator finds best execution path</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>✓ Intent-based trading model</li>
            <li>✓ Self-custody with non-custodial execution</li>
            <li>✓ Best execution optimization</li>
            <li>✓ Multiple intent types supported</li>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Specify constraints (price, amount, route)</li>
            <li>Submit to intent network</li>
            <li>Review execution quote</li>
          </ol>
        </section>
